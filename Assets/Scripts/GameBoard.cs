...
public class GameBoard : MonoBehaviour{
    ...
    void Start(){
        ...
        foreach (GameObject o in objects){
            ...
            if (o.name != "PacMan" && o.name != "Nodes" && o.name != "NonNodes" && o.name != "Maze" && o.name != "Pellets" && o.name != "Ghost" && o.name != "ghostHome" && o.name != "Canvas" && o.tag != "UIElements")
            {
    ...
    {
        Debug.Log("Player number " + playerNum + " can move to the next level");
        if (playerNum == 1)
        {
    ...
    IEnumerator ProcessWin(float delay)
    {
        ...
        foreach(GameObject ghost in o)
        {
            ...
            ghost.transform.GetComponent<Ghost>().enabled = false;
        }
    ...
    public void StartConsumed(Ghost consumedGhost)
    {
        if (!didStartConsumed)
        {
            ...
            //wait for the auio clip finished
